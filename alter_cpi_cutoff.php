...
if(isset($_POST['submit']))
{
  ...
  try{
  $sql1 = "update placement.open_to set cpi_cutoff = :cpi_cutoff where cname = :cname and profile_name = :profile_name and company_id = :company_id";
  ...
  {
    echo '<script>alert("CPI Updated Successfully! Please send a notfication to update the students") </script>';
  }
}
catch (PDOException $e) {
  //echo "Connection failed: ".$e->getMessage();
echo '<script>alert("CPI cannot be updated. Check the entered details. Contact the administrator if you think this is a mistake.") </script>';
}
}
